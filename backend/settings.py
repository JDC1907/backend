...
BASE_DIR = Path(__file__).resolve().parent.parent #ruta del proyecto
...
SECRET_KEY = 'django-insecure-am@@#p*8r7iy$tto1%5fyh!ay1__y3s-*)%#-13a6tgb@jp!dv'
...
firebase_admin.initialize_app(FIREBASE_CRED, {
     'databaseURL': 'https://landing-c96d7-default-rtdb.firebaseio.com/'
})
